...
Vagrant::Config.run do |config|
  ...
  # config.vm.share_folder("debvbox-www", "/vagrant", "./data")
  ...
  # the file devboxVagrant.pp in the manifests_path directory.

  config.vm.define "devbox" do |default_config|

    # Puppet
    default_config.vm.provision :puppet do |puppet|
      puppet.facter = { "fqdn" => "dev.local", "hostname" => "devbox" }
      puppet.manifests_path = "./puppet/manifests"
      puppet.manifest_file  = "debian-nginx-phpfpm54-mysql.pp"
